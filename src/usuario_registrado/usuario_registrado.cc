...
void Usuario_registrado::inscribirse(Curso c,std::list<Curso> lista_cursos_){ //Función que se ejecuta si todos los requisitos de la funcion inscribir_usuario de Curso se cumplen.
